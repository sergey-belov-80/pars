...
$url = 'http://eurotrans.by/wp-admin/admin-ajax.php?action=get_calendar_events&noheader=true&start_date=1469998800&end_date=1473541200&show_expired=false&event_category_id=peterburg_minsk';
$ob = new \app\Pars();
$data = $ob->parsUrl($url);
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-6" style="text-align: center">
            <h2>Август. Санкт-Петербург - Минск</h2>
        </div>
        <div class="col-md-3">
            <a href="/page/amp.php">Минск - Санкт-Петербург</a>
        </div>
    </div>
    <div class="row">
        <table class="table">
