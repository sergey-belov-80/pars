...
$url = 'http://eurotrans.by/wp-admin/admin-ajax.php?action=get_calendar_events&noheader=true&start_date=1469998800&end_date=1473541200&show_expired=false&event_category_id=minsk_peterburg';
$ob = new \app\Pars();
$data = $ob->parsUrl($url);
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-6" style="text-align: center">
            <h2>Август. Минск - Санкт-Петербург</h2>
        </div>
        <div class="col-md-3">
            <a href="/page/apm.php">Санкт-Петербург - Минск</a>
        </div>
    </div>
    <div class="row">
        <table class="table">
